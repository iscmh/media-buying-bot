// ==UserScript==
// @name         Stake VND → USD Display (Mobile)
// @namespace    https://oclus.io
// @version      5.0.0
// @description  Cosmetic USD overlay for content creation (VND mode for mobile)
// @match        *://stake.c/*
// @match        *://*.stake.c/*
// @match        *://stake.com/*
// @match        *://*.stake.com/*
...
(function () {
  ...
  // ── INSTANT CSS HIDE — prevents any flash of Vietnamese flag ──
  ...
  console.log("[Stake VND→USD] v5 mobile active");
})();
