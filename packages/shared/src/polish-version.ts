 ...
 */
export const POLISH_VERSION = '28.2.4';
...
export const POLISH_RELEASE_NAME =
  'Polish-28.2.4 Commit 77 - Nano Banana emits 9:16 not 1:1 + pad preserves aspect (fixes non-vertical character + HeyGen letterbox/crop)';
