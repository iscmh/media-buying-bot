...
describe('Polish-21.0.15: POLISH_VERSION constant', () => {
  it('is a MAJOR.MINOR.PATCH string in the Polish-21/23/24/25 series', () => {
    ...
    expect(POLISH_VERSION).toMatch(/^2(1|3|4|5)\.\d+\.\d+$/);
  });

  it('is currently 25.3.3 (Polish-25.3 Commit 18b-hotfix-2 — bump this pin deliberately on the next release)', () => {
    ...
    // a silent edit.
    expect(POLISH_VERSION).toBe('25.3.3');
  });
