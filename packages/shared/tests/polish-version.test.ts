...
describe('Polish-21.0.15: POLISH_VERSION constant', () => {
  ...
  it('is currently 29.0.34 (Polish-29.0.34 Commit 143 — WORDS_PER_CLIP 16→18 = 135 wpm, remove all forced-comma insertion, Claude maxTokens 8000→16000)', () => {
    ...
    // a silent edit.
    expect(POLISH_VERSION).toBe('29.0.34');
  });
