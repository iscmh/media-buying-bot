...
describe('Polish-21.0.15: POLISH_VERSION constant', () => {
  it('is a MAJOR.MINOR.PATCH string in the Polish-21/23/24/25/26 series', () => {
    ...
    expect(POLISH_VERSION).toMatch(/^2(1|3|4|5|6)\.\d+\.\d+$/);
  });

  it('is currently 25.6.2 (Polish-25.6 Commit 36 — bump this pin deliberately on the next release)', () => {
    ...
    // a silent edit.
    expect(POLISH_VERSION).toBe('25.6.2');
  });
