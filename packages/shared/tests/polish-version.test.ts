...
describe('Polish-21.0.15: POLISH_VERSION constant', () => {
  it('is a MAJOR.MINOR.PATCH string in the Polish-21/23/24/25 series', () => {
    ...
    // Polish-25 series launched with the MakeUGC pivot Commit 1.
    expect(POLISH_VERSION).toMatch(/^2(1|3|4|5)\.0\.\d+$/);
  });

  it('is currently 25.0.3 (Polish-25 Commit 3 — bump this pin deliberately on the next hotfix)', () => {
    ...
    // a silent edit.
    expect(POLISH_VERSION).toBe('25.0.3');
  });
