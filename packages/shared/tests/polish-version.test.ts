...
describe('Polish-21.0.15: POLISH_VERSION constant', () => {
  ...
  it('is currently 29.0.59 (Polish-29.0.59 Commit 168 — fill-runtime prompt (no silent gaps) + dynamic script word target scaled by source duration)', () => {
    ...
    // a silent edit.
    expect(POLISH_VERSION).toBe('29.0.59');
  });
