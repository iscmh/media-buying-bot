...
describe('Polish-21.0.15: POLISH_VERSION constant', () => {
  it('is a MAJOR.MINOR.PATCH string in the Polish-21/23/24/25/26/28 series', () => {
    ...
    expect(POLISH_VERSION).toMatch(/^2(1|3|4|5|6|7|8|9|10)\.\d+\.\d+$|^26\.\d+\.\d+$/);
  });

  it('is currently 26.0.14 (Polish-26.0.14 Commit 62.4 hotfix — bump this pin deliberately on the next release)', () => {
    ...
    // a silent edit.
    expect(POLISH_VERSION).toBe('26.0.14');
  });
