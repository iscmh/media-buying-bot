...
describe('Polish-21.0.15: POLISH_VERSION constant', () => {
  ...
  it('is currently 28.0.12 (Polish-28.0.12 Commit 64.12 hotfix — unzip fofr/toolkit frame-extract output before jimp decode)', () => {
    ...
    // a silent edit.
    expect(POLISH_VERSION).toBe('28.0.12');
  });
