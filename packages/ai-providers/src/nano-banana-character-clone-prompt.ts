...
export function composeNanoBananaCharacterClonePrompt(
  ...
  return [
    ...
    '{',
    '  "framing": "head and upper chest, subject centered, slight up-angle',
    '  as if holding phone at chest level with arm extended toward face",',
    '  "camera": "iPhone-style front-camera selfie perspective (~26mm wide),',
    '  candid amateur composition, mild lens distortion typical of phone selfies",',
    ...
    '- No hands, arms visible in frame, no product hold-ups, no gestures',
