...
Next, synthesize all of your findings from Step 1 into a single, detailed, Sora-optimized prompt. Use the following template precisely.

### Sora Prompt for High-Fidelity UGC Video:
