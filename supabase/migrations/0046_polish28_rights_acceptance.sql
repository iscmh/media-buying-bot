...
COMMENT ON COLUMN public.user_settings.polish28_rights_accepted_at IS
  'Polish-28.0.0 Commit 64: timestamp of user acknowledgment of the ' ||
  'HeyGen Avatar IV likeness-rights TOS. NULL = never acknowledged; ' ||
  'first Polish-28 generation attempt surfaces the modal. Non-NULL = ' ||
  'timestamp of acceptance; modal suppressed thereafter.';
